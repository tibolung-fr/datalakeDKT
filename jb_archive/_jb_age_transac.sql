...
select *,
Floor(-(date(but_creation_date)-tdt_date_to_ordered_date)/354.25) as age_transaction_magasin,
( case 
  when age_transaction_magasin >= 2 then 1
  when age_transaction_magasin < 2 then 0
 end) as is_progression
from 
       (SELECT TOP 100
        ...
        where tdt_date_to_ordered_date = '2020-06-19' -- and tdt_date_to_ordered_date < '2021-01-01'
